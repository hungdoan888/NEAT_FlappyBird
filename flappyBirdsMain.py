...
class Pipe:
    ...
    def __init__(self, x):
        ...
        self.top = 0
        self.bottom = 0
        self.PIPE_TOP = pygame.transform.flip(PIPE_IMG, False, True)  # Flips Pipe Image
    ...
    def draw(self, win):
        win.blit(self.PIPE_TOP, (self.x, self.top))  # top
...
def main():
    bird = Bird(230, 350)  # initial position of the bird
    base = Base(730)
    pipes = [Pipe(700)]
